# Generated by Django 3.2.5 on 2021-07-06 10:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('landingpad', '0002_auto_20210705_1548'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='customer',
            name='reason',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='landingpad.returnreason'),
        ),
        migrations.AlterField(
            model_name='device',
            name='name_of_device',
            field=models.CharField(blank=True, max_length=100, null=True, verbose_name='name of device'),
        ),
    ]
