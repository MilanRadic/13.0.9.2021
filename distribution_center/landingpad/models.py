...
#from landingpad.models import ProductionInformation
...
class Device(models.Model):
    ...
    price_of_device = models.DecimalField(max_length=100, blank=True, null=True, editable=True, verbose_name="device price in €", default='0', max_digits=8, decimal_places=2)
    weight_of_the_device = models.PositiveIntegerField(blank=True, null=True, default='0', verbose_name="weight of device in kg")
    size_of_the_device = models.PositiveIntegerField(blank=True, null=True, default='0', verbose_name="size of device in cm")
